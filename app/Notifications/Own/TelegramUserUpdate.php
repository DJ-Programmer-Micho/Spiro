...
class TelegramUserUpdate extends Notification
{
    ...
    public function __construct(
        $u_id, $name, $email, $password, $role, $status, $jobTitle, $nationalId, $actualEmail,$phoneNumberOne,$phoneNumberTwo,$salaryDollar,$salaryIraqi,$filename, $old_user_data, $tele_id)
    {
        $this->u_id = $u_id;
        $this->name = $name;
        $this->email = $email;
