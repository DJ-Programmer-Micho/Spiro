...
class TelegramInvoiceNew extends Notification
{
    ...
    public function __construct($addBy, $i_id, $date, $quotationId, $clientId, $paymentId, $desc, $exchangeRate, $service, $taxDollar, $discountDollar, $fisrtpayDollar, $dueDollar, $taxIraqi, $discountIraqi, $fisrtpayIraqi, $dueIraqi, $totalDollar, $totalIraqi, $grandTotalDollar, $grandTotalIraqi, $tele_id)
    {
        $this->addBy = $addBy;
        $this->i_id = $i_id;
        $this->date = $date;
