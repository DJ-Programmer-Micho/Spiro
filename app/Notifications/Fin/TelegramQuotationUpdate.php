...
class TelegramQuotationUpdate extends Notification
{
   ...
   // protected $dueIraqi;
    ...
    public function __construct($addBy, $q_id, $date, $clientId, $paymentId, $desc, $exchangeRate, $service, $discountDollar, $discountIraqi, $totalDollar, $totalIraqi, $notes, $status, $quotationStatus, $old_quotation_data, $tele_id)
    {
        $this->addBy = $addBy;
        $this->q_id = $q_id;
        $this->date = $date;
