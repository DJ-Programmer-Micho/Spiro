...
use App\Notifications\Own\TelegramAttendNew;
use App\Notifications\Own\TelegramAttendUpdate;
use App\Notifications\Own\TelegramAttendDelete;
...
class AttendanceLivewire extends Component
{
    ...
    public function render() {
        ...
        return view('livewire.own.attendance-table',[
            'items' => $data,
            'cols_th' => $cols_th,
            'cols_td' => $cols_td,
            'colspan' => $colspan
