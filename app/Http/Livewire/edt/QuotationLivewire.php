...
use App\Notifications\Edt\TelegramInvoiceNew;
use App\Notifications\Edt\TelegramQuotationNew;
use App\Notifications\Edt\TelegramQuotationShort;
use App\Notifications\Edt\TelegramQuotationUpdate;
...
class QuotationLivewire extends Component
{
    ...
    public function calculateTotals() {
        ...
        if($this->discountDollar > $this->totalDollar) {
            $this->dicountLower = true;
        } else {
            $this->dicountLower = false;
        }
    }
    ...
    public function notAllowed(){
        $this->dispatchBrowserEvent('alert', ['type' => 'info',  'message' => __('Really?, Only Admin And Finance Are Allowed to do this Action!')]);
    ...
    public function render() {
        ...
        return view('livewire.edt.quotation-table',[
            'items' => $data,
            'cols_th' => $cols_th,
            'cols_td' => $cols_td,
            'colspan' => $colspan
