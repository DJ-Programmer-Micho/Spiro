...
use App\Notifications\Fin\TelegramExpenseNew;
use App\Notifications\Fin\TelegramExpenseUpdate;
use App\Notifications\Fin\TelegramExpenseShort;
...
class ExpenseLivewire extends Component
{
    ...
    public function editExpenseBillModalStartup(int $expenseId){
        ...
        try {
            ...
            if ($expenseEdit) {
                ...
                return redirect()->to('fin/expense');
            }
        } catch (\Exception $e){
    ...
    public function render()
    {
        ...
        return view('livewire.fin.expense-table',[
            'items' => $data,
            'cols_th' => $cols_th,
            'cols_td' => $cols_td,
            'colspan' => $colspan,
