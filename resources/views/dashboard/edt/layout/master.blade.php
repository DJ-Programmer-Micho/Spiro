...
<body id="page-top">
    ...
    <div id="wrapper" >
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item {{(request()->path() == 'edt') ? 'active' : ''}}">
                <a class="nav-link" href="{{route('edt.dashboard')}}">
                    <lord-icon
            ...
            <!-- Nav Item  -->
            <li class="nav-item {{(request()->path() == 'edt/client') ? 'active' : ''}}">
                <a class="nav-link"  href="{{route('edt.client')}}">
                    <lord-icon
            ...
            <li class="nav-item  {{(request()->path() == 'edt/quotation') ? 'active' : ''}}">
                <a class="nav-link" href="{{route('edt.quotation')}}">
                    <lord-icon
            ...
            <li class="nav-item  {{(request()->path() == 'edt/invoice') ? 'active' : ''}}">
                <a class="nav-link" href="{{route('edt.invoice')}}">
                    <lord-icon
                    src="https://cdn.lordicon.com/wzwygmng.json"
                    trigger="loop"
                    delay="1500"
            ...
            <li class="nav-item  {{(request()->path() == 'edt/cash') ? 'active' : ''}}">
                <a class="nav-link" href="{{route('edt.cash')}}">
                    <lord-icon
                    src="https://cdn.lordicon.com/wzwygmng.json"
                    trigger="loop"
                    delay="1500"
            ...
            <!-- Nav Item - Main Menu -->
            <li class="nav-item {{(request()->path() == 'edt/mytask') ? 'active' : ''}}">
                <a class="nav-link" href="{{route('edt.mytask')}}">
                    <lord-icon
