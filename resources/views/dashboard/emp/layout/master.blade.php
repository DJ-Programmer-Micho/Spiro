        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon">
                    ...
                    <img src="{{asset('assets/dashboard/img/mainlogo.png')}}" alt="GLAM PRODUCTION" width="50">
                </div>
                <div class="sidebar-brand-text mx-3">GLAM PRODUCTION</div>
            </a>
            ...
            <!-- Nav Item - Main Menu -->
            <li class="nav-item {{(request()->path() == 'emp/mytask') ? 'active' : ''}}">
                <a class="nav-link" href="{{route('emp.mytask')}}">
                    <lord-icon
