...
<div>  
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="discountDollar" wire:model="discountDollar" class="form-control" id="discountDollarAdd" wire:change="calculateTotals">
                                    <small class="text-info">{{__('(Read & Write)')}}</small>
                                </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success submitJs" @if($dicountLower == true) disabled @endif>{{__('Save')}}</button>
                    </div>
                </form>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="mb-3">
                                    <label>{{__('Discount:')}} ($)</label>
                                    <input type="number" name="discountDollar" wire:model="discountDollar" class="form-control" id="discountDollarEdit" wire:change="calculateTotals">
                                    <small class="text-info">{{__('(Read & Write)')}}</small>
                                </div>
