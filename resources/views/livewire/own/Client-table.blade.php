<div>
    @include('livewire.own.client-form')
    <div class="m-4">
                ...
                <tbody>
                    ...
                    <tr style="font-size: 14px">
                        ...
                        <td>
                            ...
                            <button type="button" data-toggle="modal" data-target="#deleteClientModal"
                                wire:click="deleteClient({{ $item->id }})" class="btn btn-danger m-1">
