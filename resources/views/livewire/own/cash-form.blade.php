                ...
                <form wire:submit.prevent="">
                    <div class="modal-body">
                        <div class="modal-header">
                            <h5 class="modal-title" id="selectNewCash" style="color: #31fbe2">{{__('Add New Cash Receipt')}}</h5>
                            <button type="button" class="btn btn-danger" data-dismiss="modal" aria-label="Close" wire:click="closeModal">
                                <span aria-hidden="true"><i class="fas fa-times"></i></span>
                            </button>
                        </div>
                        <h5 class="mt-4 mb-1"><b>{{__('Invoice Information')}}</b></h5>
                        <div class="row">
                            <div class="col-12 ">
