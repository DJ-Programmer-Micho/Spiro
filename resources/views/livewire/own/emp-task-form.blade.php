                ...
                <form wire:submit.prevent="addTask">
                    <div class="modal-body">
                        ...
                        <div class="row d-flex justify-content-between m-0">
                            ...
                            <div>
                                <button class="btn btn-info" type="button" wire:click="newRecPayment">{{__('New Task')}}</button>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <table class="table table-dark table-striped table-bordered border-dark align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="align-middle" scope="row">{{$index + 1}}</td>
                                            <td class="align-middle" width="90px">
                                                <input type="date" name="arr_tasks.{{ $index }}.payment_date" wire:model="arr_payments.{{ $index }}.payment_date" class="form-control" id="arr_payments.{{ $index }}.payment_date" @if($index == 0 && $hasFirstPayment) disabled @endif required>
                                            <td class="align-middle">
                                                <select
                                                wire:model="arr_tasks.{{$index}}.name"
                                                class="form-control"
